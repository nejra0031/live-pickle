...
export function generateRoundRobinSchedule(teamIds, numCourts, startOffset = 0) {
...
export function generateRemainingRoundRobinSchedule(teamIds, playedPairKeys, numCourts) {
  if (!teamIds || teamIds.length < 2) return [];
  const remaining = [];
