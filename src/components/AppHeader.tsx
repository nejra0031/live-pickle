          ...
          <div className="flex items-center gap-3 py-3">
            ...
            <div className="flex-1 min-w-0">
              <h1
                ...
                style={{ fontSize: 'clamp(16px,4vw,26px)', color: '#0f4c75' }}
              >
                {tournamentTitle}
              </h1>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {Object.values(presence).some((v: unknown) => (v as number) > 0) && (
                ...
                {!online && (
                  <span
                    style={{ fontSize: 'clamp(9px,2vw,11px)', color: '#dc2626', fontWeight: 700 }}
                  >
                    ● Offline
                  </span>
                )}
