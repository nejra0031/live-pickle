...
import type { TournamentState, TournamentSnapshot } from './types';

export function snapshotToState(
  s: TournamentSnapshot,
  derived: Partial<TournamentState> = {}
): Partial<TournamentState> {
  const values: Partial<TournamentState> = {
