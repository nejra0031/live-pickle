      ...
      {isAdmin ? (
        ...
        >
          ...
          {notEnoughTeams ? (
            ...
            <p style={hintStyle}>
              ...
              reached. Click Finish to end, increase or clear the target in ⚙️ Tournament Settings
              to keep playing, or switch to Round Robin mode.
            </p>
          ) : (
            <>
              <button
        ...
        >
          ...
          {hasPermission(role, 'canGenerateRound') && gamesPerTeamMet && (
            <p style={hintStyle}>
              All teams have played {gamesPerTeam} game{gamesPerTeam !== 1 ? 's' : ''} — target
              reached. Waiting for the organizer to finish or continue.
            </p>
          )}
          <button onClick={onTournamentSettings} style={settingsBtnStyle}>
            ⚙️ Tournament Settings
