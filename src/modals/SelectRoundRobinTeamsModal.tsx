...
export default function SelectRoundRobinTeamsModal({
  ...
  const teamCount = selectedTeams.size,
    courtCount = selectedCourts.size;
    ...
    <div className="modal-overlay">
      ...
      >
            ...
            {rankedTeamIds.map((id, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className="inline-flex items-center rounded-full font-bold flex-1"
                    style={{
                      background: t.color,
                      color: t.text,
                      padding: '4px 10px',
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => canConfirm && onConfirm([...selectedTeams], orderedCourts)}
            disabled={!canConfirm}
