...
export default function EditTPTGameModal({ gameLabel, sideALabel, sideBLabel, teamAId, teamBId, currentResult, onSave, onClose }) {
  const aScore0 = currentResult
    ? (currentResult.winnerTeamId === teamAId ? currentResult.winnerScore : currentResult.loserScore)
    : '';
  const bScore0 = currentResult
    ? (currentResult.winnerTeamId === teamBId ? currentResult.winnerScore : currentResult.loserScore)
    : '';
